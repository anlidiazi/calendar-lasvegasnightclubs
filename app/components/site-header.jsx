...
export default function SiteHeader() {
  return (
    <header className="border-t-4 border-brand bg-black">
      <div className="mx-auto flex h-[7.1875rem] max-w-[70rem] items-center px-3">
        <SiteLogo />
      </div>
      ...
      >
        <div className="mx-auto max-w-[70rem] overflow-x-auto px-3 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          <ul className="flex h-[5.625rem] w-max min-w-full items-center justify-start p-0 lg:pl-[2.1875rem]">
